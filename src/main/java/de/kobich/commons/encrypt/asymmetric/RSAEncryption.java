package de.kobich.commons.encrypt.asymmetric;
...
public class RSAEncryption {
	...
	// Create 256-bit (32Byte) SecretKey from Passphrase;
	 ...
	 */
	public KeyPair createKey() throws EncryptionException {
		try {
	 ...
	 * @throws EncryptionException
	 */
	public String encrypt(KeyPair keyPair, String input) throws EncryptionException {
		try { 
	 ...
	 * @throws EncryptionException
	 */
	public String decrypt(KeyPair keyPair, String input) throws EncryptionException {
		try {
